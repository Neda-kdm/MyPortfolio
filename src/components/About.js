              ...
              <div className="container">
                  ...
                  <div className="split-about">
                    <motion.div initial={{x: '-100%', opacity: 0}} whileInView={horizontal} className="about-content">
                        <p>Hello! My name is Neda and I am Cloud Engineer with a strong foundation in software development and experience supporting cloud infrastructure on AWS. </p>
                        <br />
